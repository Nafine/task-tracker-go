...
var markDoneCmd = &cobra.Command{
	Use:   "mark-done [id]",
	Short: "Mark specified task as done",
	Long:  "marks specified task by id as done if such task was found",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		found, err := taskService.Mark(idx, model.StatusDone)
		if err != nil {
			return fmt.Errorf("could not mark task: %w", err)
		}
